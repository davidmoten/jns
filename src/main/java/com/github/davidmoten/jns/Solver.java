...
public class Solver {
    ...
    private double solveForPressure(Cell cell, Function<Double, Double> continuityFunction) {
        ...
        final Optional<Double> p = NewtonsMethod.solve(continuityFunction, cell.pressure(), h,
    ...
    // cell
        ...
        return getGradient(f, cell.neighbour(d, -1), c, cell.neighbour(d, 1), d, derivativeType);
    }
    ...
    private static boolean is(CellType ct1, CellType ct2, CellType ct3, CellTriplet t) {
        ...
        return t.c1().type() == ct1 && t.c2().type() == ct2 && t.c3().type() == ct3;
    }
