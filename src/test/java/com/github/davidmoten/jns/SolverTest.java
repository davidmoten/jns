...
public class SolverTest {
	...
	public void test2DUpDerivative() {
		...
		Cell cell = mesh.cell(5, 9, 0);
		double v = solver.getPressureGradient(cell, Direction.UP);
	}
	...
	public void testWhirlpool() {
		...
		assertEquals(0.0,
				cell.neighbour(Direction.NORTH, -1).velocity().east(),
				VELOCITY_PRECISION);
		...
		assertEquals(0.0, cell2.neighbour(Direction.NORTH, -1).velocity()
				.east(), VELOCITY_PRECISION);
	}
