...
public class CellImpl implements Cell {
    ...
    private CellImpl(CellType type, Vector position, double pressure, Vector velocity,
            double density, double viscosity, Cell west, Cell east, Cell south, Cell north,
            Cell down, Cell up) {
        this.type = type;
